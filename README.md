...
The user will be able to add the name of the trasnaction, its amount, and if it has been added or subtracted from their account whislt they are offline. Once they've added their information, a graph will appear to show them their result in addition to their current total. 
